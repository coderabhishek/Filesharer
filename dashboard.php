...
<!-- Dialogue box opens here-->
  <div class="modal fade" id="delete_box" role="dialog">
    <div class="modal-dialog">
    
  <form role="form" method="get" action="delete_file.php">
  <div class="form-group">
  ...
  <div class="modal fade" id="notificationss_box" role="dialog">
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        while($row=$res->fetch_assoc())
          if($row["seen"]=='1')
            echo "<a href=".$row['link'].">".$row['link']."</a>  From  <i>".$row["creator"]."<i><br><br>";
...
<div class="row">
  ...
  ?>
  	...
  	<div class="col-xm-8" style="background-color:white;">
...
<!-- FILE TABLE STARTS HERE -->
  ...
  $query = "SELECT * FROM files where uid=".$_SESSION["id"].";";
  if($result=$conn->query($query))
{
...
echo "<td>".$row['file_name']."</td>"."<td>".$type."</td>"."<td>".$row['file_tag']."</td>"."<td>".round($row['file_size']/1000000+1)."<br>";
...
<div class="container">
  <button type="button" class="btn btn-lng" id="delete_file" ><span class="glyphicon glyphicon-folder-open"></span>DELETE FILE</button>
<br><br>  
